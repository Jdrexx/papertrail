...
class Settings:
    ...
    MAX_UPLOAD_BYTES: int = 25 * 1024 * 1024  # per-file upload cap (25 MB)
    MAX_TEXT_LENGTH: int = 200_000  # ingest/process text cap (chars)
    SUPPORTED_PLAN_EXTENSIONS: frozenset = frozenset(
